...
urlpatterns = [
    ...
    path("yes24/run/", views.run_yes24_pipeline, name="yes24_run"),
    path("yes24/stream/<str:job_id>/", views.yes24_pipeline_stream, name="yes24_stream"),
    path("yes24/candidates/", views.get_yes24_candidates, name="yes24_candidates"),
    path("yes24/apply/", views.apply_yes24_candidate, name="yes24_apply"),
    path("yes24/dismiss/", views.dismiss_yes24_candidates, name="yes24_dismiss"),
    path("yes24/reset/", views.reset_yes24_candidates, name="yes24_reset"),
]
